...
@section('body')
        ...
        <div class="items-start justify-center px-4 py-12 md:flex 2xl:px-20 md:px-6">
            ...
            <form class="mt-6 xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0" method="POST" action="{{ route('add_cart') }}"
                ...
                <button type="submit" id="submit-cart"
                    class="flex items-center justify-center w-full py-4 text-base font-bold leading-none text-white bg-gray-800 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700">
    ...
    @else
        <span class="inline-block px-8 py-6 text-lg italic text-gray-500">Produk Tidak Ditemukan</span>
    @endif
@endsection
@section('script')
    <script>
