<div class="h-screen py-4">
    <div class="flex flex-col items-center gap-6 px-6">
        ...
        <div class="flex flex-col gap-y-3 navigation">
            ...
            {{-- <a href="https://forms.gle/QmmjfFP7Pq5fnEkK7" target="_blank"
                class="px-6 py-4 overflow-hidden text-lg font-bold transition-all duration-300 ease-in-out border-4 rounded-lg shadow-md hover:shadow-xl sm:px-14 nav-link">
                <i class="mr-4 fa-solid fa-circle-check"></i> Konfirmasi Alamat Pengiriman
            </a> --}}
        </div>
    </div>
    <div class="flex justify-center p-2 mx-auto mt-6 overflow-hidden rounded-full w-fit toggle-navigation">
        <span class="font-semibold text-black underline cursor-pointer toggle-nav-link">Hide Navigation</span>
    </div>
</div>
